...
\
Press p to pause the game. If the game is paused, press p to resume the game and keep the snake\'92s direction as before the pause, or press w/a/s/d to resume the game and change the snake\'92s direction.\
\
...
2. Purple Apple - If the snake eats a purple apple, its speed decreases by 1 (Minimum = 1). If player restarts the game, snake\'92s speed is reset to default (or the given speed from command line). The possibility of generating a purple apple is 6%.\
\
